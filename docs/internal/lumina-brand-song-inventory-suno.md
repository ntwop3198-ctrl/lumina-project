...
네 칸을 한 장으로 본다. 청소년 편과 성인 챈트 곡은 **섞어 부르지 않는다.**
...
**합계:** 청소년 13 v1 + 거북이 5 + 오그랑땡 5 + Real Talk 4 + True Beauty 4 = **31 v1 트랙.**  
대기: 청소년 009 초안, 015 프레임.
...
4. 음원 생성은 정본 붙여넣기 파일로. 이 문서는 목록이다.

---

## 한 줄

> **청소년은 구소 없이 13곡이 잠겼고, 성인은 거북이·오그랑땡·Real Talk·True Beauty가 챈트로 닫혔다. 009와 015만 남았다.**
