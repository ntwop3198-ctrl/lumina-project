...
**합계:** 청소년 13 v1 + 거북이 5 + 오그랑땡 5 + Real Talk 4 + True Beauty 4 + 더하다 1 + 반팔티 1 + 강물 1 + 입추 1 + 운동 1 + 재물학 1 + 네 갈래 1 + 고추잠자리 1 = **39 v1 트랙.**  
...
> **고추잠자리는 2-1이다. 잠자리는 거울이고, 009·015와 더하다 상호가 남았다.**
