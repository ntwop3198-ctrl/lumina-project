...
| **2-3 성찰·초월** | 입추, 바람의 결이 달라질 때 | **여** A안 | 72 | 구소구고구기 · 진공묘유 | [#12](https://github.com/ntwop3198-ctrl/lumina-project/pull/12) draft | **v1 KO** · 24절기 색인 |
| **11-1 신체·활력** | 운동부터 해라 | **남** | 82 | 구소구고구기 · 진공묘유 | [#13](https://github.com/ntwop3198-ctrl/lumina-project/pull/13) draft | **v1 KO** · **사람곡** |
| **2-1 자족·자립** | 성인의 재물학 | **남** | 72 | 구소구고구기 · 진공묘유 | [#14](https://github.com/ntwop3198-ctrl/lumina-project/pull/14) draft | **v1 KO** · 비로소 교정 |
| **7-1 불교** | 재물의 네 갈래 | **남** | 72 | 구소구고구기 · 진공묘유 | [#15](https://github.com/ntwop3198-ctrl/lumina-project/pull/15) draft | **v1 KO** · 뜻을 빌림 |
| **2-1 자족·자립** | 노을 속 고추잠자리 | **여** A안 | 105 | 구소구고구기 · 진공묘유 | [#16](https://github.com/ntwop3198-ctrl/lumina-project/pull/16) draft | **v1 KO** · 훅은 고추잠자리 |
| **4-1 고향·향수** | 헛간에서 보낸 밤 | **남** A안 | 68 | 구소구고구기 · 진공묘유 | [#17](https://github.com/ntwop3198-ctrl/lumina-project/pull/17) draft | **v1 KO** · 1-4 부메모 · 복돼지 짝 |
| **2-2 성공·동기부여** | 나비의 외침 | **여** A안 | 110 | 구소구고구기 · 진공묘유 | [#18](https://github.com/ntwop3198-ctrl/lumina-project/pull/18) draft | **v1 KO** · 모기 짝 · 品牌歌 아님 |
| **4-1 고향·향수** | 복돼지의 자부심 | **남** A안 | 108 | 구소구고구기 · 진공묘유 | [#19](https://github.com/ntwop3198-ctrl/lumina-project/pull/19) draft | **v1 KO** · 헛간 짝 · 品牌歌 아님 |

**합계:** 청소년 13 v1 + 거북이 5 + 오그랑땡 5 + Real Talk 4 + True Beauty 4 + 더하다 1 + 반팔티 1 + 강물 1 + 입추 1 + 운동 1 + 재물학 1 + 네 갈래 1 + 고추잠자리 1 + 헛간 1 + 나비 1 + 복돼지 1 = **42 v1 트랙.**  
대기: 청소년 009 초안, 015 프레임, 더하다 **상호**, 24절기 나머지 23, 운동 **수신인 확인**, 재물 연작 후덕재물·재산인취·정명, **모기의 항변**(5-2 · 구소 뺌), 뒷산의 염소 · 소 곡.
...
## I. 입추, 바람의 결이 달라질 때 — 2-3

정본: `lumina-ipchu-baram-ui-gyeol-suno.md`  
붙여넣기: `lumina-ipchu-baram-ui-gyeol-suno-paste.md`  
색인: `lumina-24-jeolgi-series-suno.md`

메인 **2-3**. 11-4 · 1-3 메인 · 13-1 · 品牌歌 제외.

| 항목 | 잠금 |
|------|------|
| 훅 | 입추라 하더니 정말 가을이 오나 보다 |
| 뼈대 | 잡으려 안달복달 애쓰지 않아도 |
| 연작 | 색인이 집 · 칸은 곡마다 |
...
정본: `lumina-undongbuteo-haera-suno.md`  
붙여넣기: `lumina-undongbuteo-haera-suno-paste.md`

메인 **11-1**. 11-3은 부메모. 1-3 · 2-1 메인 · 品牌歌 제외. **사람곡**.
...
정본: `lumina-seongin-ui-jaemulhak-suno.md`  
붙여넣기: `lumina-seongin-ui-jaemulhak-suno-paste.md`

메인 **2-1**. 2-4 부메모. 14-5 · 2-2 · 品牌歌 제외. **비로소** 교정.
...
정본: `lumina-jaemur-ui-ne-gallae-suno.md`  
붙여넣기: `lumina-jaemur-ui-ne-gallae-suno-paste.md`  
색인: `lumina-wealth-series-suno.md`

메인 **7-1**. 2-4 · 2-1 · 14-5 · 品牌歌 제외. 소개는 **뜻을 빌림**.
...
정본: `lumina-gochu-jamjari-suno.md`  
붙여넣기: `lumina-gochu-jamjari-suno-paste.md`

메인 **2-1**. 11-4 · 8 · 4-1 · 2-2 · 品牌歌 제외. DistroKid 제목 **노을 속 고추잠자리** (1981 동명곡 검색). 후렴 훅은 **날아라 고추잠자리**.

| 항목 | 잠금 |
|------|------|
| 훅 | 날아라 고추잠자리 저 넓은 하늘로 |
| 닫는 문 | 서두를 것 없이 나답게 가면 되지 |
| 제목 | 노을 속 고추잠자리 |
...
정본: `lumina-heotganeseo-bonaen-bam-suno.md`  
붙여넣기: `lumina-heotganeseo-bonaen-bam-suno-paste.md`  
짝: `lumina-heotgan-bokdwaeji-pair-suno.md`

메인 **4-1**. 1-4 부메모. 1-2 · 2-3 · 5-1 · 4-3 · 品牌歌 제외. 늦가을 개 장면은 **가사에 풀지 않음**. 고마운 쪽은 **복돼지의 자부심**.

| 항목 | 잠금 |
|------|------|
| 훅 | 헛간에서 보낸 밤 |
| 닫는 문 | 그 시절의 봄과 가을이 남아있네 |
| 부메모 | 국 한 그릇 · 1-4 |
...
정본: `lumina-nabi-ui-oechim-suno.md`  
붙여넣기: `lumina-nabi-ui-oechim-suno-paste.md`  
색인: `lumina-mogi-nabi-pair-suno.md`

메인 **2-2**. 8 · 11-4 · 2-3 · 5-2 · 品牌歌 제외. 함평·이니스프리는 가사에 없어 찍지 않음.

| 항목 | 잠금 |
|------|------|
| 훅 | 나비야 나비야 나를 빠뜨리지 마라 |
| 닫는 문 | 모기야 파리야 나처럼 날아봐라 |
| 짝 | 모기의 항변 5-2 대기 · 구소 뺌 |

---

## P. 복돼지의 자부심 — 4-1

정본: `lumina-bokdwaeji-ui-jabusim-suno.md`  
붙여넣기: `lumina-bokdwaeji-ui-jabusim-suno-paste.md`  
색인: `lumina-heotgan-bokdwaeji-pair-suno.md`

메인 **4-1**. 1-4 부메모. 12-1 · 12-2 · 5-1 · 品牌歌 제외. 한돈·도드람·목우촌은 가사에 없어 찍지 않음.
...
**나답게** 도 두 번 쓰지 않는다. 청소년 **003** 은 숙제·물음(#9). **노을 속 고추잠자리** 는 성인이 제 걸음을 걷는 2-1. 입추의 가을은 2-3 내려놓음의 옷이다.

**그 시절** 도 한 줄과 무대를 가른다. 고추잠자리의 언덕길은 한 줄. **헛간에서 보낸 밤** 의 봄과 가을은 무대(4-1). 부모 사랑은 부메모.

**모기·나비** 도 형식이 같다고 칸을 합치지 않는다. 모기는 웃고(5-2), 나비는 세운다(2-2).

**헛간·복돼지** 는 같은 집이다. 아이는 울고, 돼지는 고맙다. 둘 다 4-1. 소 곡은 자기 노동이라 이 짝에 넣지 않는다.
...
6. **24절기** 나머지 — 한 곡씩 판교. 통째로 11-4에 넣지 않음.  
7. **운동부터 해라** — 수신인 공개 여부 한 줄.  
8. **재물 연작** — 후덕재물 · 재산인취 · 정명 가사 수신 후 판교.  
9. **모기의 항변** — 가사 수신 → 구소 빼고 5-2 판교.  
10. **뒷산의 염소 · 소 곡** — 가사 수신 후 판교. 소는 12-2를 먼저 본다.  
11. 음원 생성은 정본 붙여넣기 파일로. 이 문서는 목록이다.

---

## 한 줄

> **복돼지의 자부심은 4-1이다. 헛간과 한 쌍이고, 009·015와 더하다 상호가 남았다.**
