...
다섯 칸 + 제안용 1칸을 한 장으로 본다. 청소년 편과 성인 챈트 곡은 **섞어 부르지 않는다.** 상호 공란 제안곡은 상호가 **붙은** 브랜드곡과 **섞지 않는다.**
...
색인: `lumina-dangsin-ege-deohada-brand-song.md`  
정본: `lumina-dangsin-ege-deohada-suno.md`  
붙여넣기: `lumina-dangsin-ege-deohada-suno-paste.md`  
Korean warm pop-dance · 118 bpm · **KO만.**

**브랜드곡(CM) 맞음. 상호는 잠그지 않음.** 가사에 상호가 없다.  
LG유플러스는 슬로건 「당신의 일상에 즐거움을 더하다」와 후렴이 닮아 **가설**일 뿐 정본이 아니다.  
메인 분류 1-3(위로·치유) **제외.** 보조 6(일상·연결)은 결만 맞음.

| Suno 제목 | 훅 | 상태 |
|-----------|-----|------|
| 당신에게 더하다 | 당신에게 더하다 오늘도 더하다 | **v1 KO** · 상호 공란 |

제안용이면 후렴에 상호 1회. 시연용이면 샘플 칸 유지.  
씨유·지에스25처럼 상호가 **붙은** 곡과 한 매대에 두지 않는다.

데모(마스터 아님): https://suno.com/song/b84e36d3-609d-468b-8d61-e199c526ce82
...
「당신에게 더하다」의 구소 챈트는 거북이·오그랑땡과 **소리가 같아도 칸이 다르다.** 여기는 고객 헌신, 거북이는 한 걸음(求小).

---

## 다음

1. 청소년 **015** 초안 수신 → 판정 → v1 · paste pack 편입.  
2. 청소년 **009** 초안 수신 → 판정 → v1.  
3. Real Talk · True Beauty **KO 원곡**을 같은 문법으로 닫을지 여부.  
4. 「당신에게 더하다」 **상호 한 줄** — 제안용이면 후렴 삽입, 시연용이면 공란 유지.  
5. 음원 생성은 정본 붙여넣기 파일로. 이 문서는 목록이다.

---

## 한 줄

> **청소년 13곡과 성인 챈트 4칸은 그대로다. 더하다는 브랜드곡이되 상호 공란이라 여섯 번째 칸에 샘플로 둔다.**
