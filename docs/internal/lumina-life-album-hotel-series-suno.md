# 인생 앨범 — 호텔·코인세탁 시리즈 (2026-06)

> **2026-06-12** 새벽~오후 · Claude(휴대폰) × Gemini × Cursor · 호텔 생활 · 협의이혼 · 코인세탁소  
> 무거운 곡(낙엽·완이화·원앙·있는 그대로) 사이 **위트·순리·맨땅** 트랙
...
| # | 제목 | 장르 | 문서 | 비고 |
|---|------|------|------|------|
| 1 | **인생 뭐있나** | Acoustic folk | `lumina-insaeng-mwo-itna-suno.md` | 求小求苦求己 Bridge |
| 2 | **코인세탁기** | Upbeat trot | `lumina-coin-laundry-suno.md` | 빙글빙글 |
| 3 | **맨땅에 헤딩** | Acoustic rock | `lumina-bare-ground-heading-suno.md` | 백지·골 Outro |
| 4 | **코인세탁소에서 만난 사람** | Acoustic folk | `lumina-coin-laundry-meeting-suno.md` | **현장 인연** |
| 5 | **점집 골목** | Dark satirical folk | `lumina-fortune-street-suno.md` | 내가 우선 · 수봉 EP Track 4 |
| 6 | **나를 등불로** | Orchestral · Finale | `lumina-be-your-own-light-suno.md` | 자등明 |
| 7 | **명의 전쟁** | Dark folk · spoken | `lumina-war-of-names-suno.md` | 수봉 EP 6 |
| 8 | **할 일이 있다는 것** | Warm orchestral | `lumina-having-something-to-do-suno.md` | **EP True Finale** |
...
| **받지 않음** (철학 시드) | `lumina-not-receiving-dharma-note.md` |
| **벽은 벽이고 벽이 아니다** (KO) | `lumina-modern-diamond-sutra-suno.md` |
| **삼국어 인덱스** | `lumina-modern-diamond-sutra-trilingual-suno.md` |
| **고구려 듀얼** | `lumina-goguryeo-dual-suno.md` |
| **담덕의 노래** | `lumina-damdeok-song-suno.md` |
| **고구려의 눈물** | `lumina-tears-of-goguryeo-suno.md` |
| **名利双收** (풍자 트로트) | `lumina-mingli-shuangshou-suno.md` |
| **그냥 그냥** (KO 시드) | `lumina-geunyang-geunyang-suno.md` |
| **모르면 정답** (v3) | `lumina-moreumyeon-jeongdap-suno.md` |
| **Not Knowing Is the Answer** (EN v1) | `lumina-moreumyeon-jeongdap-english-suno.md` |
| **Just Like That** (EN v2) | `lumina-geunyang-geunyang-english-suno.md` |
| **삼국어 인덱스** | `lumina-geunyang-geunyang-trilingual-suno.md` |
| **이순신 — 바다의 별** (v4) | `lumina-yi-sun-sin-star-of-the-sea-suno.md` |
| **신사임당 — 붓끝에 핀 꽃** | `lumina-saimdang-flowers-on-the-brush-suno.md` |
| **장보고 — 바다의 왕** | `lumina-jang-bogo-king-of-the-sea-suno.md` |
| **율곡 이이 — 개혁의 별** | `lumina-yulgok-yi-i-star-of-reform-suno.md` |
| **모자(母子) 시리즈** | `lumina-saimdang-yulgok-mother-son-suno.md` |
| **퇴계 이황 — 道의 빛** | `lumina-toegye-yi-hwang-light-of-the-way-suno.md` |
| **성리학 듀얼** | `lumina-toegye-yulgok-neo-confucian-dual-suno.md` |
...
| **빽** (v2) | `lumina-baek-suno.md` |
| **Be Your Own Backing** (EN v1) | `lumina-baek-english-suno.md` |
| **남매 (南妹)** | `lumina-nammae-nanmei-suno.md` |
| **자기 그릇** | `lumina-jagi-geureut-suno.md` |
| **다산의 노래** | `lumina-dasan-song-suno.md` |
| **간디의 길** | `lumina-gandhi-path-suno.md` |
...
| **放过自己** (ZH v1) | `lumina-fangguo-ziji-let-yourself-go-chinese-suno.md` |
...
| **正心正身正事** (ZH v1) | `lumina-zhengxin-zhengshen-zhengshi-chinese-suno.md` |
| **정심·정신·정사** (KO v1) | `lumina-zhengxin-zhengshen-zhengshi-suno.md` |
| **Correct Mind, Body, and Work** (EN v1) | `lumina-zhengxin-zhengshen-zhengshi-english-suno.md` |
...
| **받지 않으면 너꺼** (Spiritual KO v2) | `lumina-bad-eumyeon-neoggeo-spiritual-ballad-suno.md` |
| **하나인 그림자** (KO · EN · ZH v1) | `lumina-hana-in-geurimja-shadow-of-one-suno.md` · `-english-suno.md` · `-chinese-suno.md` |
| **문을 닫는 법** (7언어 v1) | `lumina-muneul-datneun-beop-how-to-close-the-door-suno.md` · … · `lumina-muneul-datneun-beop-how-to-close-the-door-multilingual-suno.md` |
| **养运** (KO · ZH · EN v1) | `lumina-yang-yun-cultivating-fortune-suno.md` · … · `lumina-yang-yun-cultivating-fortune-multilingual-suno.md` |
| **완벽한 인생은 없다** (KO v1) | `lumina-wanbyeokhan-insaengeun-eopda-no-perfect-life-suno.md` |
| **가장 가까운 사람에게** (KO v1) | `lumina-gajang-gakkaun-saram-ege-to-the-closest-one-suno.md` |
| **친구** (KO v1.1) | `lumina-chingu-friend-suno.md` |
...
| **독하게 살아야 행복하다** (KO v1) | `lumina-dokhage-saraya-haengbokhada-fierce-happiness-suno.md` |
| **狠心才能幸福** (ZH v1) | `lumina-dokhage-saraya-haengbokhada-fierce-happiness-chinese-suno.md` |
| **Fierce Happiness** (EN v1) | `lumina-dokhage-saraya-haengbokhada-fierce-happiness-english-suno.md` |
| **多语索引** | `lumina-dokhage-saraya-haengbokhada-fierce-happiness-multilingual-suno.md` |
| **마음이 거울이 되어** (KO v1 · 성화스님 헌정) | `lumina-maeumi-geoul-i-doeeo-mirror-mind-suno.md` |
| **心如明镜** (ZH v1 · 헌정) | `lumina-xin-ru-mingjing-mirror-mind-chinese-suno.md` |
...
| **6语索引** | `lumina-apeunikka-sarangida-because-it-hurts-its-love-multilingual-suno.md` |
| **好好活着 / 잘 살아가기** (한·중 v1) | `lumina-haohao-huozhe-live-well-suno.md` |
| **Live Well / 生きていこう** (英·日 v1) | `lumina-haohao-huozhe-live-well-english-japanese-suno.md` |
| **Bien Vivre / Sống Thật Tốt** (法·越 v1) | `lumina-haohao-huozhe-live-well-french-vietnamese-suno.md` |
| **6语索引** | `lumina-haohao-huozhe-live-well-multilingual-suno.md` |
| **행복은 습관이다** (KO v1) | `lumina-haengbogeun-seubgwannida-happiness-is-a-habit-suno.md` |
| **幸福是一种习惯** (ZH v1) | `lumina-xingfu-shi-yizhong-xiguan-happiness-is-a-habit-chinese-suno.md` |
| **Happiness is a Habit** (EN v1) | `lumina-haengbogeun-seubgwannida-happiness-is-a-habit-english-suno.md` |
| **三语索引** | `lumina-haengbogeun-seubgwannida-happiness-is-a-habit-multilingual-suno.md` |
...
| **I Don't Like the Sky** (EN v1 · 짝곡) | `lumina-haneul-sireoyo-i-dont-like-the-sky-english-suno.md` |
| **我喜欢地下** (ZH v1) | `lumina-jihaga-joa-i-like-the-basement-chinese-suno.md` |
| **I Like the Basement** (EN v1) | `lumina-jihaga-joa-i-like-the-basement-english-suno.md` |
| **Trilingual** | `lumina-jihaga-joa-i-like-the-basement-multilingual-suno.md` |
| **괘씸한 세상** (KO v1) | `lumina-gwaessimhan-sesang-annoying-world-suno.md` |
| **봄春 Spring** (KO · ZH · EN v1) | `lumina-bom-chun-spring-suno.md` · `-chinese-suno.md` · `-english-suno.md` · `lumina-bom-chun-spring-trilingual-suno.md` |
| **信任粉碎** (ZH v1 · 原稿) | `lumina-xinren-fensui-trust-shattered-chinese-suno.md` |
| **예수님의 사랑** | `lumina-yesu-sarang-suno.md` |
| **테레사 수녀의 길** (KO v1) | `lumina-teresa-suyeoui-gil-mother-teresa-path-suno.md` |
| **妈祖** (ZH v1 · 默娘·海上之光) | `lumina-mazu-sea-light-chinese-suno.md` |
| **마조** (KO v1 · 묵낭·바다 위의 빛) | `lumina-mazu-sea-light-suno.md` |
| **Mazu** (EN v1 · Light Over the Sea) | `lumina-mazu-sea-light-english-suno.md` |
| **遇人不淑** (ZH v1) | `lumina-yurenbushu-wrong-match-chinese-suno.md` |
...
| **禅歌 7연** | `lumina-zen-heart-koan-trilogy-multilingual-suno.md` |
| **觀世音** (한중 혼용 v1 · 관세음) | `lumina-guan-shi-yin-listener-of-world-mixed-suno.md` |
| **密勒日巴** (한중 혼용 v1 · Milarepa) | `lumina-milarepa-mileriba-mixed-suno.md` |
| **天符經** (한·한자 v1 · 천부경) | `lumina-cheonbugyeong-tianfu-jing-mixed-suno.md` |
| **你就是我** (한중 v1 · 不二·山延) | `lumina-ni-shi-wo-you-are-me-mixed-suno.md` |
| **你就是我** (ZH v1) | `lumina-ni-shi-wo-you-are-me-chinese-suno.md` |
| **You Are Me** (EN v1) | `lumina-ni-shi-wo-you-are-me-english-suno.md` |
| **三语索引** | `lumina-ni-shi-wo-you-are-me-multilingual-suno.md` |
| **저수지 둑아** (KO v1.1 · 새벽 일꾼·둑·바다) | `lumina-jeosuji-ddung-a-reservoir-dam-suno.md` |
| **水库堤坝啊** (ZH v1) | `lumina-jeosuji-ddung-a-reservoir-dam-chinese-suno.md` |
| **Reservoir Dam** (EN v1) | `lumina-jeosuji-ddung-a-reservoir-dam-english-suno.md` |
| **貯水池の堤よ** (JA v1) | `lumina-jeosuji-ddung-a-reservoir-dam-japanese-suno.md` |
| **Con Đập Hồ Chứa Ơi** (VI v1) | `lumina-jeosuji-ddung-a-reservoir-dam-vietnamese-suno.md` |
| **柳毅传书** (ZH v1 · 山东·信却中了) | `lumina-liu-yi-chuan-shu-legend-chinese-suno.md` |
| **혼자가 좋다** (KO v1 · 혼술·담백) | `lumina-honjaga-jota-i-like-being-alone-suno.md` |
...
| **天の川** (JA v1) | `lumina-eunhasu-chilseok-cowherd-weaver-japanese-suno.md` |
| **Dải Ngân Hà** (VI v1) | `lumina-eunhasu-chilseok-cowherd-weaver-vietnamese-suno.md` |
| **Starlight** (KO v1 · 향화·별빛 아래) | `lumina-starlight-byeolbit-arae-suno.md` |
| **星光** (ZH v1 · 향화) | `lumina-starlight-byeolbit-arae-chinese-suno.md` |
| **Starlight** (EN v1 · 향화) | `lumina-starlight-byeolbit-arae-english-suno.md` |
| **五语索引** | `lumina-jeosuji-ddung-a-multilingual-suno.md` |
| **多语·향화 가이드** | `lumina-jeosuji-ddung-a-multilingual-suno.md` |
| **북으로 간 스승** (KO v1 · 경허 선사·아이들) | `lumina-buk-euro-gan-seuseung-gyeongheo-suno.md` |
| **命由我作** (KO·한자 v1 · 了凡四训) | `lumina-liaofan-ming-you-wo-zuo-fate-in-my-hands-suno.md` |
...
| **청소년 편 판교 팩** (001–008 · 010 · 011) | `lumina-youth-identity-series-suno-paste.md` |
...
1. **코인세탁기** — 트로트·후크 먼저 (가장 Suno 친화)  
2. **인생 뭐있나** — 포크·철학  
3. **맨땅에 헤딩** — 록·에너지  
4. **코인세탁소에서 만난 사람** — 스토리·잔잔한 마무리  
...
| 역할 | 담당 |
|------|------|
| 새벽 가사·아이디어 | Claude (휴대폰) + Gemini |
| Suno Style·검수·문서 | Cursor |
| 현장 | 루미나님 — 코인세탁소 · 동갑 인연 |
...
- **22일** — 새 사무실 (여주·세종·문광부 제안 온라인)  
- **월드컵** — 2026-06-13 미국 vs 파라과이 (한국시간 20:00) · 전일 한국 2-1 체코
